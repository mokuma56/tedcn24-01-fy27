...
## Step 5: Browse the Integration Catalog
...
![](../screenshots/84ff424d-integrations-catalog-showing-available-mcp-server-tiles.png)

## Step 6: 1.2 Configure an Integration
...
![](../screenshots/84ff424d-admin-console-integrations-page-showing-the-list-of-configur.png)

![](../screenshots/84ff424d-create-integration-pop-up-with-the-integration-name-drop-dow.png)

![](../screenshots/84ff424d-create-integration-form-showing-the-host-url-and-api-token-f.png)

## Step 7: 1.3 Verify the Connection
...
## Step 8: 1.4 Use Your Integrations in Canvas
...
![](../screenshots/84ff424d-canvas-with-a-user-query-fetching-details-for-a-specific-ser.png)

![](../screenshots/84ff424d-canvas-displaying-fetched-ticket-details-including-summary.png)
